...
# Page analyzer
## Description
[Page analyzer](https://vasilyevps-page-analyzer.onrender.com) Ц a website that analyzes the specified pages for SEO suitability.

The main page (tab *√лавна€*) allows to add website site, that needs to be checked, to the database. The *—айты* tab contains a list of all sites and brief information about the last check.
